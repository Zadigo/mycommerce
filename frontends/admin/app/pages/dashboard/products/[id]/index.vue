  ...
  <q-page padding>
    <div class="row">
      <div class="col-10 offset-1">
        <page-header :current-product="currentProduct" :previous-product="previousProduct" :next-product="nextProduct" @save="handleSaveProduct" />

        <div class="row">
          <div class="col-8 q-pr-sm">
            <!-- Information -->
            <product-info v-model="requestData.name" class="q-mb-sm" />
            <!-- Category -->
            <category-info v-model="requestData" class="q-mb-sm" />
            ...
            <!-- Images -->
            <product-images :current-product="currentProduct" @update-product="handleUpdateProduct" @update-images="handleUpdateImages" />

            <!-- Sizes -->
            <size-block v-model="requestData" />
          </div>
