    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_group_category', models.CharField(choices=[('Kid', 'Kid'), ('Adult', 'Adult')], default='Adult', help_text='Additional category in order to classify products by age group', max_length=100)),
                ('gender_category', models.CharField(choices=[('Man', 'Man'), ('Woman', 'Woman'), ('Unisex', 'Unisex')], default='Unisex', help_text='Additional category in order to classify products by gender', max_length=100)),
                ('category', models.CharField(choices=[('Accessories', 'Accessories'), ('Activewear', 'Activewear'), ('Bags', 'Bags'), ('Bras', 'Bras'), ('Denim', 'Denim'), ('Dresses', 'Dresses'), ('Pants', 'Pants'), ('Panties', 'Panties'), ('Shoes', 'Shoes'), ('Skirts', 'Skirts'), ('Shorts', 'Shorts'), ('Suits', 'Suits'), ('Tops', 'Tops'), ('Not attributed', 'Not Attributed'), ('Other', 'Other')], default='Not attributed', help_text='The main category under which the product can be grouped. This allows dynamic product grouping given its category', max_length=100)),
                ...
                ('unit_price', models.FloatField(help_text='Cost value of the current product', validators=[shop.validators.price_validator])),
                ('sale_value', models.PositiveIntegerField(default=0, help_text='The current sale percentage on the product unit price')),
                ('sale_price', models.FloatField(default=0, help_text='Sale price of the current product', validators=[shop.validators.price_validator])),
                ('on_sale', models.BooleanField(default=False)),
                ('display_new', models.BooleanField(default=False, help_text='Show a product as new')),
                ('slug', models.SlugField(blank=True, max_length=200, unique=True)),
                ('validity_score', models.CharField(blank=True, help_text='Indicates whether the product fulfills all the requirements in order to be displayed on Nuxt without any fundamental issues', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(condition=models.Q(('is_main_image', True)), fields=('product',), name='unique_main_image_per_product')],
            },
        ),
        migrations.AddIndex(
            model_name='product',
            index=models.Index(condition=models.Q(('on_sale', True), ('active', True)), fields=['on_sale'], name='on_sale_products'),
        ),
        migrations.AddIndex(
            model_name='product',
        ...
        migrations.AddIndex(
            model_name='product',
            index=models.Index(fields=['category', 'active', '-created_on'], name='category_active_products'),
        ),
        migrations.AddConstraint(
            model_name='product',
            constraint=models.CheckConstraint(condition=models.Q(('unit_price__gt', 0)), name='unit_price_over_zero', violation_error_code='The unit price must be greater than zero'),
        ),
        migrations.AddConstraint(
            model_name='product',
            constraint=models.CheckConstraint(condition=models.Q(('sale_price__lt', models.F('unit_price'))), name='sale_price_lower_than_unit', violation_error_code='The sale price must be lower than the unit price'),
        ),
        migrations.AddConstraint(
            model_name='product',
            constraint=models.UniqueConstraint(fields=('name', 'color'), name='unique_name_color_product', violation_error_message='A product with the same name and color already exists'),
        ),
        migrations.AddConstraint(
            model_name='wishlist',
