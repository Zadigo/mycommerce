...
class Shipment(models.Model):
    """This is an optional model that can be used to track shipments
    associated with customer orders. You implement it or use external
    services such as ShipStation, EasyShip, etc. to track shipments."""
