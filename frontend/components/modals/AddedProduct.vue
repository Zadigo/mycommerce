    ...
    <div class="container">
      <div class="row my-3">
        <div v-if="hasProducts" class="col-12">
          ...
          <div v-if="lastAddedProduct" class="row">
            <div class="col-4">
              <!-- FIXME: Raises an error when there is no image -->
              <NuxtImg v-if="lastAddedProduct" :src="mediaPath(lastAddedProduct.product.get_main_image?.original)" :alt="lastAddedProduct.product.name" format="webp" class="img-fluid" />
