...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop', '0014_product_sub_category_alter_product_category_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='sku',
            field=models.CharField(blank=True, help_text='Stock Keeping Unit', max_length=100, null=True, unique=True, verbose_name='SKU'),
        ),
        migrations.AlterField(
            model_name='product',
            name='sub_category',
