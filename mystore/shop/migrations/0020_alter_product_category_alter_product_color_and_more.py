...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop', '0019_alter_product_options_alter_product_category_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='unit_price',
            field=models.DecimalField(decimal_places=2, default=1, help_text='Cost value of the current product', max_digits=5, validators=[shop.validators.price_validator]),
        ),
    ]
