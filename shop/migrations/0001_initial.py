    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(default='Uz9Mwqaqpd3S', max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('Black', 'Black'), ('Beige', 'Beige'), ('Camel', 'Camel'), ('Charcoal', 'Charcoal'), ('Cream', 'Cream'), ('Green', 'Green'), ('Grey', 'Grey'), ('Marine', 'Marine'), ('Navy', 'Navy'), ('Red', 'Red'), ('Taupe', 'Taupe'), ('White', 'White'), ('Yellow', 'Yellow')], default='Black', help_text='Defines a declination of a main product in color', max_length=100)),
