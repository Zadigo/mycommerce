...
type UnknownValues = string | number | Record<string, Type> | (string | number | Record<string, Type>)[]
...
declare class VueSession extends BaseStorage {
  ...
  /** */
  getOrCreate(key: string, value: UnknownValues): unknown;
  /** */
