<template>
  <base-auth>
    <template>
      <b-card-text>
        <auth-fields :show-login-fields="false" :login-fields="loginFields" :signup-fields="signupFields" @login-credentials="updateLoginFields" @signup-credentials="updateSignupFields" />

        <!-- <v-col cols="12">
          <p class="my-1 text-white text-left">Vous n'avez pas encore de compte ? <a @click="showLoginFields=false">Créer un compte</a></p>
