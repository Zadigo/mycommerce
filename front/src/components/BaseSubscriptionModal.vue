      ...
      <v-row class="p-5">        
        <v-col cols="12">
          ...
          <p class="text-muted">
            ...
            lancement de nouveaux produits, des informations privilégiées sur les salons et d'autres 
            détails que vous ne pouvez pas manquer. Vous ne le regretterez pas.
          </p>
