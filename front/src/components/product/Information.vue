...
import Actions from '../shop/product/Actions.vue'
import AdditionalInformation from '@/product/TechnicalInformation.vue'
import SizeGuide from "../shop/product/SizeGuide.vue"
